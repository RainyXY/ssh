				...
				<div class="services">	
					<div class="section group">
						...
						<div class="grid_1_of_4 main/images_1_of_4">
							<c:forEach var="sellhouse" items="${sellHouseModels}">
								<a href="" class="swipebox" title="Image Title"> <img
									src="main/test/showsellphoto.action?s_house_id=${sellhouse.s_house_id}" alt=""><span
									class="zoom-icon"></span>
								</a>
								<p style:"float:left">地址:${sellhouse.s_house_address}</p>
								<p style:"float:left">房屋价格:${sellhouse.s_house_price}</p>
								<a href="main/test/tosellmessage.action?s_house_id=${sellhouse.s_house_id}"
									class="link">Read More</a>
								<br />
								<a href="contract/contract/toshow.action?s_house_id=${sellhouse.s_house_id}"
									class="link">是否购买</a>
							</c:forEach>
							
							<fmt:message key="yeshu" /><!-- 页数 -->:${pageIndex} <fmt:message key="gong" /><!-- 共 -->/${pages}<fmt:message key="ye" /><!-- 页 -->
							<a href="main/test/tosellshow.action?pageIndex=${pageIndex-1}"><fmt:message key="shangye" /><!-- 上页 --></a>
							<a href="main/test/tosellshow.action?pageIndex=${pageIndex+1}"><fmt:message key="xiaye" /><!-- 下页 --></a>
						</div>
				...
				<div class="col span_1_of_about1">
					...
					<div class="single-right">
						...
						<div id="loginbox" class="loginbox">
							<form action="main/test/tosellshow.action" method="post" name="login"
								id="login-form">
